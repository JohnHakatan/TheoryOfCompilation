...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_OR = 19,                        /* OR  */
  YYSYMBOL_AND = 20,                       /* AND  */
  YYSYMBOL_EQUALITY_OP = 21,               /* EQUALITY_OP  */
  YYSYMBOL_RELATIONAL_OP = 22,             /* RELATIONAL_OP  */
  YYSYMBOL_ADDITIVE_BINOP = 23,            /* ADDITIVE_BINOP  */
  YYSYMBOL_MULTIPLICATIVE_BINOP = 24,      /* MULTIPLICATIVE_BINOP  */
  YYSYMBOL_NOT = 25,                       /* NOT  */
...
static const char *const yytname[] =
{
  ...
  "SC", "ID", "NUM", "STRING", "ASSIGN", "OR", "AND", "EQUALITY_OP",
  "RELATIONAL_OP", "ADDITIVE_BINOP", "MULTIPLICATIVE_BINOP", "NOT",
  "RPAREN", "LPAREN", "RBRACE", "LBRACE", "ELSE", "$accept", "Program",
  "Statements", "Statement", "Call", "Type", "Exp", YY_NULLPTR
};
...
{
      63,   -18,   -18,   -18,    -3,   -13,     2,    10,    23,   -12,
      63,    50,    63,   -18,    38,    46,   -18,    11,    11,   -18,
     -18,    11,    11,    36,   -18,   -18,   -18,   -11,   -18,   -18,
      41,    57,   -18,    11,    78,   -18,    94,   102,    77,   110,
     -18,   -18,    11,   -18,   -18,    37,   118,    11,    11,    11,
      11,    11,    11,    63,    63,   -18,   -18,    88,    11,   -18,
      35,    66,    -2,   -15,    47,   -18,    49,   -18,   -18,   -18,
      63,   -18
};
...
{
      14,    37,    25,    41,    38,    39,    21,    42,    51,    52,
      14,    16,    14,    25,    17,    22,    44,    46,    28,    29,
      50,    51,    52,    14,    19,    57,    30,    31,    32,    18,
      60,    61,    62,    63,    64,    65,    33,    20,    34,     1,
       2,    69,     3,    66,    67,     4,     5,     6,     7,     8,
      24,     9,    26,    14,    14,    48,    49,    50,    51,    52,
      71,    27,    43,    58,    40,    10,     1,     2,    22,     3,
      14,    52,     4,     5,     6,     7,     8,    23,     9,    70,
       0,     1,     2,     0,     3,    28,    29,    49,    50,    51,
      52,    55,    10,    30,    31,    32,    47,    48,    49,    50,
      51,    52,    68,    33,    45,    34,     0,    47,    48,    49,
      50,    51,    52,    47,    48,    49,    50,    51,    52,     0,
      53,    47,    48,    49,    50,    51,    52,     0,    54,    47,
      48,    49,    50,    51,    52,     0,    56,    47,    48,    49,
      50,    51,    52,     0,    59
};

static const yytype_int8 yycheck[] =
{
       0,    18,    12,    14,    21,    22,    18,    18,    23,    24,
      10,    14,    12,    23,    27,    27,    33,    34,     7,     8,
      22,    23,    24,    23,    14,    42,    15,    16,    17,    27,
      47,    48,    49,    50,    51,    52,    25,    14,    27,     3,
       4,    58,     6,    53,    54,     9,    10,    11,    12,    13,
       0,    15,    14,    53,    54,    20,    21,    22,    23,    24,
      70,    15,     5,    26,    28,    29,     3,     4,    27,     6,
      70,    24,     9,    10,    11,    12,    13,    10,    15,    30,
      -1,     3,     4,    -1,     6,     7,     8,    21,    22,    23,
      24,    14,    29,    15,    16,    17,    19,    20,    21,    22,
      23,    24,    14,    25,    34,    27,    -1,    19,    20,    21,
      22,    23,    24,    19,    20,    21,    22,    23,    24,    -1,
      26,    19,    20,    21,    22,    23,    24,    -1,    26,    19,
      20,    21,    22,    23,    24,    -1,    26,    19,    20,    21,
      22,    23,    24,    -1,    26
};
...
static const yytype_int8 yystos[] =
{
      ...
      29,    32,    33,    34,    35,    36,    14,    27,    27,    14,
      14,    18,    27,    33,     0,    34,    14,    15,     7,     8,
      15,    16,    17,    25,    27,    35,    37,    37,    37,    37,
      28,    14,    18,     5,    37,    36,    37,    19,    20,    21,
      22,    23,    24,    26,    26,    14,    26,    37,    26,    26,
...
#line 1278 "parser.tab.cpp"
  ...
  case 21: /* Exp: Exp ADDITIVE_BINOP Exp  */
#line 78 "parser.ypp"
                             { output::printProductionRule(20); }
#line 1284 "parser.tab.cpp"
    break;

  case 22: /* Exp: Exp MULTIPLICATIVE_BINOP Exp  */
#line 79 "parser.ypp"
                                   { output::printProductionRule(20); }
...
#line 1350 "parser.tab.cpp"
  ...
  case 33: /* Exp: Exp EQUALITY_OP Exp  */
#line 90 "parser.ypp"
                          { output::printProductionRule(31); }
#line 1356 "parser.tab.cpp"
    break;

  case 34: /* Exp: Exp RELATIONAL_OP Exp  */
#line 91 "parser.ypp"
                            { output::printProductionRule(31); }
